   ...
   public void testGetYear() {
	...
	@Test
     ...
     public void testGetFirstMilisecond1()
     {
         ...
         assertEquals(1672531200000L, quarter.getFirstMillisecond(Calendar.getInstance(timeZone)));
     }
       @Test
     public void testGetFirstMillisecond2()
     {
         ...
         calendar.set(Calendar.MILLISECOND, 0);
         assertEquals(1680307200000L,quarter.getFirstMillisecond(Calendar.getInstance(timeZone)));
     }
     @Test
     public void testGetFirstMillisecond3()
     {
         ...
         calendar.set(Calendar.MILLISECOND, 0);
         assertEquals(1640995200000L,quarter.getFirstMillisecond(Calendar.getInstance(timeZone)));
     }
     @Test
     public void testGetFirstMillisecond4()
     {
         ...
         calendar.set(Calendar.MILLISECOND, 0);
         assertEquals(1648771200000L,quarter.getFirstMillisecond(Calendar.getInstance(timeZone)));
     }
     @Test
